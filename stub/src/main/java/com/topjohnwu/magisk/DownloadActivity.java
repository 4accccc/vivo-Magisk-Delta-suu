...
public class DownloadActivity extends Activity {
    ...
    private static final String APP_NAME = "Kitsune Lite";
    private static final String JSON_URL = BuildConfig.DEBUG ?
            "https://huskydg.github.io/magisk-files/debug_lite.json" :
            "https://huskydg.github.io/magisk-files/canary_lite.json";
